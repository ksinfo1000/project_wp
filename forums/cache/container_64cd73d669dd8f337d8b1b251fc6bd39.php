...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'kozhe37_foums', 'UVn+-axs-5a7', 'kozhe37_foums', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'kozhe37_foums',
            'dbal.dbpasswd' => 'UVn+-axs-5a7',
            'dbal.dbname' => 'kozhe37_foums',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
