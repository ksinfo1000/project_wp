...
/* acp_bots.html */
class __TwigTemplate_6953b74776a1496ca7f66c88e5dc0567fd5dc4ca8d387e60c2c33ee6eb01cb3e extends Twig_Template
{
...
\t";
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_loops_, "bots", array()));
...
\t\t\t<td style=\"width: 50%;\">";
                ...
                echo $this->getAttribute($_bots_, "BOT_NAME", array());
                echo "</td>
\t\t\t<td style=\"width: 15%; white-space: nowrap;\" align=\"center\">&nbsp;";
                // line 78
                if (isset($context["bots"])) { $_bots_ = $context["bots"]; } else { $_bots_ = null; }
                echo $this->getAttribute($_bots_, "LAST_VISIT", array());
                echo "&nbsp;</td>
\t\t\t<td style=\"text-align: center;\">&nbsp;<a href=\"";
                // line 79
                if (isset($context["bots"])) { $_bots_ = $context["bots"]; } else { $_bots_ = null; }
                echo $this->getAttribute($_bots_, "U_ACTIVATE_DEACTIVATE", array());
                echo "\" data-ajax=\"activate_deactivate\">";
                if (isset($context["bots"])) { $_bots_ = $context["bots"]; } else { $_bots_ = null; }
                echo $this->getAttribute($_bots_, "L_ACTIVATE_DEACTIVATE", array());
                echo "</a>&nbsp;</td>
\t\t\t<td style=\"text-align: center;\">&nbsp;<a href=\"";
                // line 80
                if (isset($context["bots"])) { $_bots_ = $context["bots"]; } else { $_bots_ = null; }
                echo $this->getAttribute($_bots_, "U_EDIT", array());
                echo "\">";
...
\t\t\t<td style=\"text-align: center;\">&nbsp;<a href=\"";
                // line 81
                if (isset($context["bots"])) { $_bots_ = $context["bots"]; } else { $_bots_ = null; }
                echo $this->getAttribute($_bots_, "U_DELETE", array());
...
\t\t\t<td style=\"text-align: center;\"><input type=\"checkbox\" class=\"radio\" name=\"mark[]\" value=\"";
                // line 82
                if (isset($context["bots"])) { $_bots_ = $context["bots"]; } else { $_bots_ = null; }
                echo $this->getAttribute($_bots_, "BOT_ID", array());
                echo "\" /></td>
\t\t</tr>
\t";
            }
