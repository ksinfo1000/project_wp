...
class __TwigTemplate_d5fdb423cef465dd24a09b32f80bc181b00ea128daa1dbeb036f3e4a5151625b extends Twig_Template
{
...
\t\t\t";
                    // line 30
                    if (isset($context["topicrow"])) { $_topicrow_ = $context["topicrow"]; } else { $_topicrow_ = null; }
                    if ($this->getAttribute($_topicrow_, "S_DELETED_TOPIC", array())) {
                        // line 31
                        echo "\t\t\t\t<dl>
...
";
        ...
        if (isset($context["loops"])) { $_loops_ = $context["loops"]; } else { $_loops_ = null; }
        if (isset($context["S_NO_DISPLAY_BOOKMARKS"])) { $_S_NO_DISPLAY_BOOKMARKS_ = $context["S_NO_DISPLAY_BOOKMARKS"]; } else { $_S_NO_DISPLAY_BOOKMARKS_ = null; }
        if ((twig_length_filter($this->env, $this->getAttribute($_loops_, "topicrow", array())) &&  !$_S_NO_DISPLAY_BOOKMARKS_)) {
            // line 100
