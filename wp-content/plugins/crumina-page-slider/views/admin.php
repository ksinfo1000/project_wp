...
<div class="wrap">
	...
	function crum_slider_custom_styles(){
		...
		if (!empty($slide_hover_opacity) || $slide_hover_opacity === '0'){
			...
			if ( $b_color ) {
				$custom_css .= "
				#wrpap-slider-" . $id . " #crum-slider .item .item-content-metro {   background: rgb(" . $b_color . "); background: rgba(" . $b_color . "," . $opacity . ");}
				#wrpap-slider-" . $id . " .entry-thumb a:hover {opacity: 1; background: rgba(" . $b_color . "," . $opacity . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .active .item-content:hover{background: rgb(" . $b_color . ");background: rgba(" . $b_color . "," . $opacity . ");}";

			}
			if ( $odd_b_color ) {
				$custom_css .= "
				#wrpap-slider-" . $id . " #crum-slider .item.even .item-content-metro {   background: rgb(" . $odd_b_color . ");background: rgba(" . $odd_b_color . "," . $opacity . ");}";
			}
			if ( $bg_color ) {
				$custom_css .= "
				#wrpap-slider-" . $id . ".crumina-slider-wrap .active .click-section { background: rgb(" . $bg_color . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .item-content .slider-icon-wrap{color: rgb(" . $bg_color . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .active .click-section {background:  rgb(" . $bg_color . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .item-content .slider-icon{color:  rgb(" . $bg_color . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .entry-thumb a:before{color:  rgb(" . $bg_color . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .cat-name { background: rgb(" . $bg_color . "); background: rgba(" . $bg_color . ", 0.5);}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .cat-name:hover {background: rgb(" . $bg_color . ");background: rgba(" . $bg_color . ", 1);}
				#wrpap-slider-" . $id . ".entry-thumb a:before {color: rgb(" . $bg_color . ");}
				#wrpap-slider-" . $id . ".crumina-slider-wrap .entry-title a:hover   {color: rgb(" . $bg_color . ");}";
    ...
    function crumina_slider_reset_cache($id) {
        ...
        delete_transient( 'crumina_page_slider_cache_'.$id );
        delete_transient( 'crumina_loopOutput_'.$id );
