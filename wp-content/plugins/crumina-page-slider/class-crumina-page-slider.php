...
class Crum_Page_Slider
{
	...
	public function crumina_slider_init($atts, $content = null)
    {
        ...
        */} else {
        ...
        if ( empty( $query ) ){
            ...
            set_transient('crumina_page_slider_cache_'.$slider_id, $query, $cache_time * 60);
   ...
   ?>
        ...
        <div class="crumina-slider-wrap" id="wrpap-slider-<?php echo $slider_id; ?>">
            <div id="crum-slider" class="<?php  echo 'tmp-'.$template; ?>" data-width="<?php  echo $slider_width; ?>" >
                <ul class="slidee">

                    <?php
                    if ($template == '1b-2s') {
                        include_once $page_slider_path.'/templates/template-1b-2s.php';
                    } else {
                        include_once $page_slider_path.'/templates/template-1b-4s.php';
                    } ?>
