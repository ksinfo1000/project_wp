...
switch (ICL_LANGUAGE_CODE) {
    case "uk":
        $cptch_label_form = "Код безпеки";
        break;
    case "ru":
        $cptch_label_form = "Код безопасности";
        break;
    case "en":
        $cptch_label_form = "Security code";
        break;
}
		/* captcha html - comment form */
		echo '<p class="cptch_block">';
		if ( "" != $cptch_options['cptch_label_form'] )	
//			echo '<label>' . ICL_LANGUAGE_CODE . $cptch_options['cptch_label_form'] . '<span class="required"> ' . $cptch_options['cptch_required_symbol'] . '</span></label>';
			echo '<label>' . $cptch_label_form . '<span class="required" > ' . $cptch_options['cptch_required_symbol'] . '</span>:</label>';
//		echo '<br />';
		cptch_display_captcha();
		echo '</p>';
