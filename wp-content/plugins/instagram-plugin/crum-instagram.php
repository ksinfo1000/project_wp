...
Version: 1.2
Author: Crumina (inspired by Rolly G. Bueno Jr.)
Author URI: http://crumina.info
License: GPL v2.0.
...
DEFINE('crum_simple_instagram_plugin_url', plugins_url().'/crum-instagram');
...
function option_page_crum_simple_instagram()
{
	...
	*/
	...
	<?php if( !$info['si_access_token'] && !$info['si_user_id'] ): ?> 
		...
		<?php endif; ?>
	<a href=" <?php echo crInstLogin( '?return_uri=' . base64_encode( get_admin_url() . 'options-general.php?page=crum-instagram'  )  ) ?> "><img src="<?php echo plugins_url() . '/crum-instagram/images/instagram-login.jpg'; ?>" title="Login to Instagram and authorize  Instagram plugin" alt="Login to Instagram and authorize  Instagram plugin" /></a>
	<?php ?>
	<?php else: ?>
	<?php 
