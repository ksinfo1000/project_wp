...
class WPBakeryVisualComposerSetup extends WPBakeryVisualComposerAbstract {
    ...
    public function frontCss() {
        ...
        $front_css_file = WPBakeryVisualComposerSettings::get('use_custom') == '1' ?  $this->composer->assetURL( 'css/js_composer_front_custom.css' ) : $this->composer->assetURL( 'css/js_composer_front.css' );
        wp_register_style( 'js_composer_front', $front_css_file, false, WPB_VC_VERSION, 'screen' );
        if(file_exists($this->composer->assetPath( 'css/custom.css' ))) {
            wp_register_style( 'js_composer_custom_css', $this->composer->assetURL( 'css/custom.css' ), array('js_composer_front'), WPB_VC_VERSION, 'screen' );
        }
    }
