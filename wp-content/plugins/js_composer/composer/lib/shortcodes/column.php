...
class WPBakeryShortCode_VC_Column extends WPBakeryShortCode {
    ...
    public function getColumnControls($controls, $extended_css = '') {
        ...
        $controls_add = ' <a class="column_add" href="#" title="'.__(($extended_css=='bottom-controls' ? 'Append to this column' : 'Prepend to this column'), 'js_composer').'"></a>';
    ...
    public function content( $atts, $content = null ) {
        ...
        $output .= "\n\t".'<div class="'.$css_class.'">';//class: wpb_content_element removed
