...
class WPBakeryShortCode_VC_Twitter extends WPBakeryShortCode {
    ...
    protected function content( $atts, $content = null ) {
        ...
        $css_class =  apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_twitter_widget wpb_content_element'.$width.$el_class, $this->settings['base']);
        $output .= "\n\t".'<div class="'.$css_class.'">';
...
class WPBakeryShortCode_VC_Pinterest extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        $css_class =  apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_pinterest wpb_content_element wpb_pinterest_type_'.$type, $this->settings['base']);
