...
class WPBakeryShortCode_VC_Accordion extends WPBakeryShortCode {
    ...
    protected function content( $atts, $content = null ) {
        ...
        $title = $interval = $width = $el_position = $el_class = $collapsible = '';
        //
        extract(shortcode_atts(array(
            'title' => '',
            'interval' => 0,
        ...
        $css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_accordion wpb_content_element '.$width.$el_class.' not-column-inherit', $this->settings['base']);
