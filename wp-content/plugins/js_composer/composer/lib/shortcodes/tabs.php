...
class WPBakeryShortCode_VC_Tab extends WPBakeryShortCode_VC_Column {
    ...
    public function getColumnControls($controls, $extended_css = '') {
        ...
        $controls_add = ' <a class="column_add" href="#" title="'.__(($extended_css=='bottom-controls' ? 'Append to this '.strtolower($this->settings('name')) : 'Prepend to this '.$this->settings('name')), 'js_composer').'"></a>';
        $controls_edit = ' <a class="column_edit" href="#" title="'.__('Edit this '.strtolower($this->settings('name')), 'js_composer').'"></a>';
        $controls_clone = '<a class="column_clone" href="#" title="'.__('Clone this '.strtolower($this->settings('name')), 'js_composer').'"></a>';

        $controls_delete = '<a class="column_delete" href="#" title="'.__('Delete this '.strtolower($this->settings('name')), 'js_composer').'"></a>';
...
class WPBakeryShortCode_VC_Tabs extends WPBakeryShortCode {
    ...
    public function content($atts, $content =null)
    {
        ...
        $tabs_nav .= '</ul>'."\n";
        */
        $css_class =  apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, trim($element.' wpb_content_element '.$width.$el_class), $this->settings['base']);
