...
if (!class_exists('WPBakeryShortCode')) {
    ...
    ---------------------------------------------------------- */
        public function getColumnControls($controls, $extended_css = '') {
            ...
            $controls_add = ' <a class="column_add" href="#" title="'.__('Add to '.$this->settings('name'), 'js_composer').'"></a>';
            $controls_edit = ' <a class="column_edit" href="#" title="'.__('Edit '.$this->settings('name'), 'js_composer').'"></a>';
            $controls_delete = ' <a class="column_clone" href="#" title="'.__('Clone '.$this->settings('name'), 'js_composer').'"></a> <a class="column_delete" href="#" title="'.__('Delete ' .$this->settings('name'), 'js_composer').'"></a>';
