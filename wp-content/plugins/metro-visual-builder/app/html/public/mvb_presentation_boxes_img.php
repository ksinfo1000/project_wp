...
<?php
$imgArray = array(
		6475=>'wp-content/uploads/2014/05/education.jpg',
		6477=>'wp-content/uploads/2014/05/education.jpg',
		6476=>'wp-content/uploads/2014/05/education.jpg',

		6478=>'wp-content/uploads/2014/05/health_causes1.jpg',
		6480=>'wp-content/uploads/2014/05/health_causes1.jpg',
		6479=>'wp-content/uploads/2014/05/health_causes1.jpg',

		6472=>'wp-content/uploads/2014/05/amanager.jpg',
		6474=>'wp-content/uploads/2014/05/amanager.jpg',
		6473=>'wp-content/uploads/2014/05/amanager.jpg'
		);
?>
        ...
        <div class="row">
		    ...
		    $_img = $imgArray[$panel['image']];
                    ...
                    <div class="picture" style=" <?php echo $style; ?>">
                        <?php if ($panel['image']) {
                            echo '<img src="' . $_img . '" alt="' . $panel['main_title'] . '" class="blurImage" >';
                        } ?>
