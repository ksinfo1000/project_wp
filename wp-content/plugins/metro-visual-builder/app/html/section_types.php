...
<?php foreach( $metro_admin_rows as $row_id => $row ): ?>
    <li class="row bshaper_row" id="mvb_grid_<?php echo $row_id ?>" data-mvb-bgcolor="" data-mvb-bgimage="" data-mvb-bgrepeat="" data-mvb-bgposition="" data-mvb-bg_position="" data-mvb-textcolor="" data-mvb-cssclass="" data-mvb-totop="" data-mvb-css="" data-mvb-section-padding="">
