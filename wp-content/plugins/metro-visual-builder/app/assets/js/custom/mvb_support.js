...
function initTheEditor(elements)
{
	jQuery(document).on('focusin', function(e) {
		if (jQuery(e.target).closest("div").length) {
	...
	tinyMCE.init({
		...
		theme                       : "modern",
		skin                        : "lightgray",
		plugins                     : "charmap,hr,media,paste,tabfocus,textcolor,fullscreen,wordpress,wpeditimage,wpgallery,wplink,wpdialogs,wpview,wpfullscreen,code",
		...
		resize                      : false, menubar: false, wpautop: true, indent: false,
		toolbar1                    : "bold,italic,strikethrough,bullist,numlist,blockquote,hr,alignleft,aligncenter,alignright,link,unlink,wp_more,spellchecker,wp_fullscreen,wp_adv,|,reactor_button,|,woocommerce_shortcodes_button,revslider,code",
		toolbar2                    : "formatselect,underline,alignjustify,forecolor,pastetext,removeformat,charmap,outdent,indent,undo,redo,wp_help",
		tabfocus_elements           : "insert-media-button,save-post",
		body_class                  : "acf_settings post-type-page post-status-auto-draft",
		width                       : 780,
		height                      : 300,
		elements                    : elements
	});
