...
class MVB_Posts_Carousel
{
    ...
    {
        return array(
            'title'           =>      __('Post carousel', 'mvb'),
            'description'     =>      __('Display posts slider', 'mvb'),
    ...
    public static function fields()
    {
        ...
        $the_fields = array(
			...
			'show_description' => array(
				'type' => 'select',
				'label'     =>      __('Display description on slides', 'mvb'),
				'default'   =>      0,
				'options'   =>      mvb_yes_no(),
				'col_span'  =>      'lbl_half'
			),
	 ...
	 * @return shortcode output
	 */
    public static function render( $atts, $cat_selected = '' )
    {
        global $mvb_metro_factory;
        ...
        $no_of_posts = $load['no_of_posts'];



        return $mvb_metro_factory->_load_view('html/public/mvb_posts_carousel.php', $load);
    }//end render();
}//end class