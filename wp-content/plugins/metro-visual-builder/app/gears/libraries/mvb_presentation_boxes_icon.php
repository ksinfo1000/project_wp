...
class MVB_Presentation_Boxes_Icon
{
    /**
    ...
    {
        return array(
            'title'           =>      __('Presentation Big Icon', 'mvb'),
            'description'     =>      __('Add a presentation box with large icon', 'mvb'),
        ...
        $the_fields = array(
            ...
            'presentation_box' => array(
                ...
                'fields'    =>      array(
                    ...
                    'separator00' => array('type'     =>  'separator'),
    ...
    public static function render( $atts, $content = null )
    {
        ...
        return $mvb_metro_factory->_load_view('html/public/mvb_presentation_boxes_icon.php', $load);
    }//end render();
}//end class