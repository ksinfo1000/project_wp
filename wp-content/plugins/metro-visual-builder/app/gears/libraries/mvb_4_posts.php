...
class MVB_4_Posts
{
    ...
    {
        return array(
            'title'           =>      __('Last 4 posts', 'mvb'),
            'description'     =>      __('Display 4 latest posts from some category', 'mvb'),
    ...
    public static function render( $atts, $cat_selected = '' )
    {
        ...
        return $mvb_metro_factory->_load_view('html/public/mvb_4_posts.php', $load);
    }//end render();
}//end class