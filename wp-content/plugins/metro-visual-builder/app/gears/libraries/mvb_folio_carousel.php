...
class MVB_Folio_Carousel
{
    ...
    {
        return array(
            'title'           =>      __('Portfolio carousel', 'mvb'),
            'description'     =>      __('Display portfolio items slider', 'mvb'),
    ...
    public static function render( $atts, $cat_selected = '' )
    {
        ...
        return $mvb_metro_factory->_load_view('html/public/mvb_folio_carousel.php', $load);
    }//end render();
}//end class