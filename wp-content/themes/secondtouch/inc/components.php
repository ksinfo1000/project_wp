...
{
    $form = '<form role="search" method="get" id="searchform" class="form-search" action="' . home_url('/') . '">
    ...
    <input type="submit" id="searchsubmit" value="' . esc_attr__('Search', 'crum') . '" class="btn">
    </form>';
