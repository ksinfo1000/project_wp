...
if ($options['stan_header']) {
    ...
    ($options['stan_header_image'] && !($custom_head_color && ($custom_head_color != '#ffffff') && ($custom_head_color != '#'))
    ) {
...
switch (ICL_LANGUAGE_CODE) {
    ...
    case "en":
        ...
        break;
                ...
                <?php if (isset($options['disable_breadcrumbs']) && (!$options['disable_breadcrumbs'])) { ?>
