...
if(!class_exists('Redux_Options') ){
    ...
    define('VERIFIER_URL', 'http://dev.crumina.net/verifier.php');
    ...
    class Redux_Options {
        ...
        */
        function __construct($sections = array(), $args = array(), $extra_tabs = array()) {
            ...
            $defaults['page_icon'] = 'awesome-themes';
        ...
        function _options_page_html() {
            ...
            foreach($this->sections as $k => $section) {
				if($this->args['icon_type'] == 'image' || (isset($section['icon_type']) && $section['icon_type'] == 'image')) {
					...
					$icon = (!isset($section['icon'])) ? '<i class="awesome-cog' . $icon_class . '"></i> ' : '<i class="awesome-' . $section['icon'] . $icon_class . '"></i> ';
				} else {
					$icon_class = (!isset($section['icon_class'])) ? '' : ' ' . $section['icon_class'];
					$icon = (!isset($section['icon'])) ? '<i class="awesome-cog' . $icon_class . '"></i> ' : '<i class="awesome-' . $section['icon'] . $icon_class . '"></i> ';
				}
            ...
            if(true === $this->args['show_import_export']) {
				...
				if(!isset($this->args['import_icon_type']) == 'image') {
					...
					$icon = (!isset($this->args['import_icon'])) ? '<i class="awesome-refresh' . $icon_class . '"></i>' : '<i class="awesome-' . $this->args['import_icon'] . $icon_class . '"></i> ';
				}
            ...
            if(is_array($this->extra_tabs)) {
				foreach($this->extra_tabs as $k => $tab) {
					if($this->args['icon_type'] == 'image' || (isset($tab['icon_type']) && $tab['icon_type'] == 'image')) {
    	                ...
    	                $icon = (!isset($tab['icon'])) ? '<i class="awesome-cog' . $icon_class . '"></i> ' : '<i class="awesome-' . $tab['icon'] . $icon_class . '"></i> ';
					} else {
						$icon_class = (!isset($tab['icon_class'])) ? '' : ' ' . $tab['icon_class'];
    	                $icon = (!isset($tab['icon'])) ? '<i class="awesome-cog' . $icon_class . '"></i> ' : '<i class="awesome-' . $tab['icon'] . $icon_class . '"></i> ';
					}
            ...
            if(true === $this->args['dev_mode']) {
				...
				if($this->args['dev_mode_icon_type'] == 'image') {
					...
					$icon = (!isset($this->args['dev_mode_icon'])) ? '<i class="awesome-info-sign' . $icon_class . '"></i>' : '<i class="awesome-' . $this->args['dev_mode_icon'] . $icon_class . '"></i> ';
				}
